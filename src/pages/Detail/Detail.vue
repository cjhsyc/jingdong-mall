                    ...
                    <div class="choose">
                        <div class="chooseArea">
                            ...
                            <dl v-for="item in spuSaleAttrList" :key="item.id">
                                ...
                                <dd :class="{active:ele.isChecked==='1'}" v-for="ele in item.spuSaleAttrValueList"
                                    :key="ele.id" @click="changeActive(ele,item.spuSaleAttrValueList)">
                                    {{ ele.saleAttrValueName }}
                                </dd>
                            </dl>
                        </div>
                        <div class="cartWrap">
                            <div class="controls">
                                <input autocomplete="off" class="itxt" v-model.lazy.number="num" @change="changeNum">
