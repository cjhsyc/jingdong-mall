        ...
        <div class="order-content">
            ...
            <div class="orders">
                <table class="order-item" v-for="item in myOrder.records" :key="item.id">
                    ...
                    <tbody>
                    <tr v-for="(ele,index) in item.orderDetailList" :key="ele.id">
                        <td width="60%">
                            <div class="typographic">
                                <img :src="ele.imgUrl" style="width: 100px;height: 100px">
                                <a class="block-text">{{ ele.skuName }}</a>
                                <span>x{{ ele.skuNum }}</span>
